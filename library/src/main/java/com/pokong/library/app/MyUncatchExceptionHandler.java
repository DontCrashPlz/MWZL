...
public class MyUncatchExceptionHandler<T extends BaseApplication> implements Thread.UncaughtExceptionHandler {
    ...
    private void collectDeciveInfo(Context ctx){
        ...
        try {
            ...
            LogUtils.d("MyUncatchExceptionHandler", "an error occured when collect package info" + e.toString());
        }
        ...
        for (Field field : fields) {
            try {
                ...
                LogUtils.d("MyUncatchExceptionHandler", field.getName() + " : " + field.get(null));
            } catch (Exception e) {
                LogUtils.d("MyUncatchExceptionHandler", "an error occured when collect crash info" + e.toString());
            }
        }
    ...
    private String saveExceptionInfo(Throwable throwable){
        ...
        try {
            ...
            LogUtils.d("MyUncatchExceptionHandler", "an error occured while writing file..." + e.toString());
        }
        return null;
    }
